...
<div class="flex flex-wrap border-4 border-black rounded-xl">
    <div class="w-5/12">
    ...
    <div class="flex flex-col items-start justify-evenly w-3/12 bg-slate-200 pl-4 border rounded-xl">
