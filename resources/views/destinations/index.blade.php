        ...
        <table class="border-collapse border-4 border-cyan-500 w-full mt-5">
          ...
          <tbody>
            @foreach ($registers as $item)    
                <tr>
                  <td class="border-4 w-screen px-4 py-2 text-center border-blue-400 font-semibold">{{$item->name}}</td>
                  <td class="border-4 w-screen px-4 py-2 text-center border-blue-400 font-semibold">{{$item->address}}</td>
                  <td class="border-4 w-screen px-4 py-2 text-center border-blue-400 font-semibold">{{$item->ranking}}</td>
                  <td class="border-4 w-screen px-4 py-2 text-center border-blue-400 font-semibold">{{Str::limit($item->description, 20)}}</td>
                  <td class="border-4 w-screen px-4 py-2 text-center border-blue-400 font-semibold">{{$item->languages}}</td>
