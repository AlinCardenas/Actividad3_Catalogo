<x-guest-layout>
    <div class="container max-w-[7xl] mx-auto mt-4">
        ...
        <x-enlace href="{{ route('services.create') }}" mensaje="Crear servico" />
        <div class="grid grid-cols-4 gap-4 mb-6 mx-auto mt-5">
            @foreach ($services as $service)
            <div class="col-span-1">
                <div class="bg-white rounded-lg shadow-2xl p-[10px] h-[350px]">
                    <div class="p-4">
                        <a class="text-xl font-bold mb-4 hover:text-purple-500"
                            href="{{route('services.show', $service->id)}}">Servicios {{$service->name}}</a>
                        <p class="text-gray-600 mb-2">Precio: ${{ $service->price }}</p>
                        <div class="mb-10">
                            <p class="text-gray-600 mb-2 text-justify">Descripcion:
